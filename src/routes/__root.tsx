...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Techfest ’26 — IIT Bombay" },
      {
        name: "description",
        content:
          "Asia's largest science and technology festival — competitions, robotics, workshops and exhibitions at IIT Bombay, Dec 17–19, 2026.",
      },
